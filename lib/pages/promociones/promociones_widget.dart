              ...
              children: [
                StreamBuilder<List<PromocionesRecord>>(
                  stream: queryPromocionesRecord(
                    queryBuilder: (promocionesRecord) => promocionesRecord
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<PromocionesRecord> listViewPromocionesRecordList =
                        snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, listViewIndex) {
                        final listViewPromocionesRecord =
                            listViewPromocionesRecordList[listViewIndex];
                        return Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.network(
                                        listViewPromocionesRecord.image,
                                        width:
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 20.0, 0.0, 20.0),
                                          child: Text(
                                            listViewPromocionesRecord.nombre,
