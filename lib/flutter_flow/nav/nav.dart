...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: InfoEmpresaWidget.routeName,
          path: InfoEmpresaWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'InfoEmpresa')
              : InfoEmpresaWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: TiendasWidget.routeName,
          path: TiendasWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Tiendas')
              : TiendasWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: RecuperarpswWidget.routeName,
          path: RecuperarpswWidget.routePath,
          builder: (context, params) => RecuperarpswWidget(),
        )
