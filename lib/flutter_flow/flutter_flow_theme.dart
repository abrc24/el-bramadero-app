...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00508C);
  late Color secondary = const Color(0xFF46B29D);
  late Color tertiary = const Color(0xFFF8F9FA);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF00508C);
  late Color secondaryText = const Color(0xFF4A4A4A);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF8F9FA);
  late Color accent1 = const Color(0xFF00508C);
  late Color accent2 = const Color(0xFF46B29D);
  late Color accent3 = const Color(0xFFF8F9FA);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF003B6D);
  late Color secondary = const Color(0xFF38A68E);
  ...
  late Color accent1 = const Color(0xFF003B6D);
  late Color accent2 = const Color(0xFF38A68E);
  late Color accent3 = const Color(0xFF2C2C2C);
  late Color accent4 = const Color(0xFF1A1A1A);
  late Color success = const Color(0xFF1E7E34);
  late Color warning = const Color(0xFFFFC107);
  late Color error = const Color(0xFFC82333);
  late Color info = const Color(0xFF138496);
}
